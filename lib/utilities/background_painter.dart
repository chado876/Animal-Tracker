...
import 'package:animal_tracker/utilities/palette.dart';
...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    // canvas.drawPaint(Paint()..color = Palette.yellow);
  ...
  void paintBlack(Canvas canvas, Size size) {
    ...
    _addPointsToPath(path, [
      Point(lerpDouble(0, size.height, blackAnim.value), 0),
      Point(size.width, size.height / 4),
      Point(size.width / 2, size.height / 4),
